...
add wave -noupdate /MIPS_tb_HW/uut/ALUSrc_X
add wave -noupdate -radix hexadecimal /MIPS_tb_HW/uut/muxALUSrc_X
...
add wave -noupdate -radix hexadecimal /MIPS_tb_HW/uut/signExt_D
add wave -noupdate -radix hexadecimal /MIPS_tb_HW/uut/signExt_X
...
add wave -noupdate /MIPS_tb_HW/uut/stall_PC_D
...
add wave -noupdate -radix hexadecimal {/MIPS_tb_HW/uut/RegBank/reg_file[31]}
...
add wave -noupdate /MIPS_tb_HW/uut/RegBank/reg_file_write
add wave -noupdate /MIPS_tb_HW/uut/stall_PC_W
...
add wave -noupdate -radix hexadecimal /MIPS_tb_HW/uut/data_mem_wr_addr_M
...
add wave -noupdate /MIPS_tb_HW/uut/Immediate_Instruction_D
add wave -noupdate /MIPS_tb_HW/uut/Instruction_rs2_D
